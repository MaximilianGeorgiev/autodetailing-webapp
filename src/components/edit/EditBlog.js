...
export const EditBlog = (props) => {
  ...
  const processBlogEditForm = () => {
    ...
    if (inputValues?.title?.value && inputValues?.text?.value) {
      ...
      updateBlog(id, inputValues.title.value, inputValues.text.value).then(
        (res) => {
          if (res.data?.status === "success")
            navigate(`/blogs/show/${id}`, {
        ...
        >
          ...
          <Box noValidate sx={{ mt: 1 }}>
            ...
            <TextField
              ...
              maxRows={5}
              value={
                inputValues["text"]?.value ? inputValues["text"].value : ""
              }
              error={
                inputValues["text"]?.error ? inputValues["text"].error : false
              }
              helperText={
