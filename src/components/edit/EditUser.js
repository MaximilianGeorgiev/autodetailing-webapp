...
export const EditUser = (props) => {
    ...
    useEffect(() => {
        ...
        if (userId !== id && !userRoles.includes("Moderator") && !userRoles.includes("Admin")) {
    ...
    const processUserEditForm = () => {
        ...
        } else if (inputValues?.phone?.value && !validatePhone(inputValues.phone.value)) {
            updatedState.phone = {
        ...
        if (
            ...
            let updateData = { user_email: inputValues.email.value, user_fullname: inputValues.fullname.value };

            if (inputValues?.phone.value && validatePhone(inputValues.phone.value))
                updateData = { ...updateData, user_phone: inputValues.phone.value };

            if (inputValues?.phone.value && !validatePhone(inputValues.phone.value)) return;
